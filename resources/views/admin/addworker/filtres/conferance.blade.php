@if($id>0)
    <?php $addInfo = json_decode($allWorkerInfo->workers_additional_info);?>
        ...
        <div class="profile_options_item ">
            ...
            <h5>Тип ведущего</h5>
            <ul>
                    <li><input type="checkbox" id = "type_conf1" name="types_conf[]" class="type_conf" @foreach($addInfo->types_conf as $type) @if($type == 1) checked @endif @endforeach
                        value=1 class="lang">
                        <label for="type_conf1"  @foreach($addInfo->types_conf as $type) @if($type == 1) class="check" @endif @endforeach>Ведущий</label>
                    </li>
                    <li><input type="checkbox" id = "type_conf2" name="types_conf[]" class="type_conf" @foreach($addInfo->types_conf as $type) @if($type == 2) checked @endif @endforeach
                        value=2 class="lang">
...
@else
        ...
        <div class="profile_options_item ">
            ...
            <h5>Тип ведущего</h5>
            <ul>
                <li><input type="checkbox" id = "type_conf1" name="types_conf[]" value=1 class="type_conf">
                    <label for="type_conf1" >Ведущий</label>
                </li>
                <li><input type="checkbox" id = "type_conf2" name="types_conf[]" value=2 class="type_conf">
